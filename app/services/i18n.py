...
TRANSLATIONS = {
    "ar": {
        ...
        "demo_data_notice": "بيانات معاملات حقيقية من UCI Online Retail بترخيص CC BY 4.0، تغطي ديسمبر 2010 إلى ديسمبر 2011، بعد تنظيف 536,639 معاملة وتجميعها يوميًا دون بيانات مبيعات صناعية.",
    ...
    "en": {
        ...
        "demo_data_notice": "Verified UCI Online Retail transactions under CC BY 4.0, covering December 2010 to December 2011, with 536,639 cleaned transactions aggregated daily and no synthetic sales.",
